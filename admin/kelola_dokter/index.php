                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>088855557777</span></td>
                        <td>Poli Kesehatan</td>
                        <td>
                          <div class="margin">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form>
                  <div class="form-group">
                    <label for="addNamaDokter">Nama</label>
                    <input type="text" class="form-control" id="addNamaDokter" placeholder="Nama" value="Dr.Witch" />
                  </div>
                  <div class="form-group">
                    <label for="addAlamatDokter">Alamat</label>
                    <input type="text" class="form-control" id="addAlamatDokter" placeholder="Alamat" value="Jalan Safelane" />
                  </div>
                  <div class="form-group">
                    <label for="addNoHPDokter">Nomor HP</label>
                    <input type="text" class="form-control" id="addNoHPDokter" placeholder="Nomor HP" value="088855557777" />
                  </div>
                  <div class="form-group">
                    <label for="addPoliDokter">Poli</label>
                    <select class="custom-select rounded-0" id="addPoliDokter">
                      <option>-------</option>
                      <option selected>Poli Kesehatan</option>
                    </select>
                  </div>
                  <div class="card-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
