          ...
          <div class="row">
            <div class="col-lg">
              <div class="card">
                ...
                <div class="card-body">
                  <p class="card-text">Selamat datang di Rumah Sakit Capstone. Klik tombol di bawah untuk mendaftar poli.</p>
                  <a href="daftar_poli" class="btn btn-primary">Pendaftaran Poli</a>
                  <br></br>
